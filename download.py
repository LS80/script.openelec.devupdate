...
import requests
import rollbar
rollbar.init('d497713ccd854c3b80f550803c118412', 'cli')

try:
    from resources.lib import builds, openelec, funcs

    rollbar.report_message('Start', 'info', extra_data=openelec.OS_RELEASE)
    ...
    rollbar.report_exc_info(extra_data=openelec.OS_RELEASE)
    raise
