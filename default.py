...
import rollbar
rollbar.init('d497713ccd854c3b80f550803c118412', 'gui')
...
try:
    ...
    SYSTEM_INFO = openelec.OS_RELEASE
    SYSTEM_INFO['ADDON_VERSION'] = addon.version
    ...
    if len(sys.argv) > 1:
        ...
        with Main() as main:
            rollbar.report_message('Start', 'info', extra_data=SYSTEM_INFO)
            main.start()
except Exception:
    rollbar.report_exc_info(extra_data=SYSTEM_INFO)
    raise
